		...
		<div className="bg-white">
			{addedItems.length !== 0 ? (
				<div className="p-2 text-center">
					<span className="border px-4 text-lg font-semibold bg-red-200 rounded-md">
				...
				<div className="flex">
					...
					{addedItems.length != 0 ? (
						<div className="w-3/12 p-5 ml-20 mt-2 h-40 bg-blue-100 shadow border-black sticky top-24">
							...
							<br></br>
							<button className="text-md font-mono bg-yellow-300 w-60 ml-10 shadow p-1 rounded-lg mt-16">
								Checkout
							</button>
						</div>
					) : (
